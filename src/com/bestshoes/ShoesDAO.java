 ...
 * 
 *         created Date : Nov 25, 2018 modified Date : Nov 25, 2018
 *         ---------------------------------------------
 *
 *         Page Task : ShoesDAO all tasks related to access database 'Shoes'
 *
 *         references db structure : Shoes itemId int NOT NULL auto_increment
 *         primary key, itemName varchar(50) NOT NULL, category varchar(10) NOT
 *         NULL, shoesize varchar(5) NOT NULL, quantity int NOT NULL, price
...
public class ShoesDAO {
	 ...
	 * private String shoesize; private int quantity; private double price;
	 */
	...
	public Shoes searchShoes(int itemId) throws Exception {
		...
		// make a query
		String selectQuery = "select itemId, itemName, category, shoesize, quantity, price, content from Shoes where itemId="
				+ itemId;
	...
	public void addRow(String itemName, String category, String shoesize, int quantity, double price, String content)
			throws Exception {
	...
	public void updateRow(int itemId, String itemName, String category, String shoesize, int quantity, double price,
